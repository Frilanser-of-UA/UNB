...
let checkboxMessage = document.querySelector('.form-popup__message');
checkbox.addEventListener('click', function () {
	if (checkbox.checked) {
		checkboxMessage.classList.add('active');
	} else {
		checkboxMessage.classList.remove('active');
	}
});
